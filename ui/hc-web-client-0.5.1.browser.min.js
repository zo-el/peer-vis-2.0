...
"use strict";var n=this&&this.__awaiter||function(n,t,e,o){return new(e||(e=Promise))(function(r,i){function c(n){try{a(o.next(n))}catch(t){i(t)}}function u(n){try{a(o.throw(n))}catch(t){i(t)}}function a(n){n.done?r(n.value):new e(function(t){t(n.value)}).then(c,u)}a((o=o.apply(n,t||[])).next())})},t=this&&this.__generator||function(n,t){var e,o,r,i,c={label:0,sent:function(){if(1&r[0])throw r[1];return r[1]},trys:[],ops:[]};return i={next:u(0),throw:u(1),return:u(2)},"function"==typeof Symbol&&(i[Symbol.iterator]=function(){return this}),i;function u(i){return function(u){return function(i){if(e)throw new TypeError("Generator is already executing.");for(;c;)try{if(e=1,o&&(r=2&i[0]?o.return:i[0]?o.throw||((r=o.return)&&r.call(o),0):o.next)&&!(r=r.call(o,i[1])).done)return r;switch(o=0,r&&(i=[2&i[0],r.value]),i[0]){case 0:case 1:r=i;break;case 4:return c.label++,{value:i[1],done:!1};case 5:c.label++,o=i[1],i=[0];continue;case 7:i=c.ops.pop(),c.trys.pop();continue;default:if(!(r=(r=c.trys).length>0&&r[r.length-1])&&(6===i[0]||2===i[0])){c=0;continue}if(3===i[0]&&(!r||i[1]>r[0]&&i[1]<r[3])){c.label=i[1];break}if(6===i[0]&&c.label<r[1]){c.label=r[1],r=i;break}if(r&&c.label<r[2]){c.label=r[2],c.ops.push(i);break}r[2]&&c.ops.pop(),c.trys.pop();continue}i=t.call(n,c)}catch(u){i=[6,u],o=0}finally{e=r=0}if(5&i[0])throw i[1];return{value:i[0]?i[1]:void 0,done:!0}}([i,u])}}},e=this;Object.defineProperty(exports,"__esModule",{value:!0});var o=require("rpc-websockets");require("isomorphic-fetch");var r="/_dna_connections.json",i=5e3;function c(){return fetch(r).then(function(n){return n.json()}).then(function(n){return n.dna_interface.driver.port}).then(function(n){return"ws://localhost:"+n})}function u(e,o,r,i){return void 0===i&&(i=null),n(this,void 0,void 0,function(){return t(this,function(n){return e.ready?[2,Promise.resolve(e.call(o,r))]:[2,new Promise(function(n,t){var c=i?setTimeout(function(){t("Timeout while waiting for ws to connect. method: "+o+", payload: "+JSON.stringify(r))},i):null;e.once("open",function(){clearTimeout(c),e.call(o,r).then(n).catch(t)})})]})})}exports.connect=function(r){return void 0===r&&(r={}),new Promise(function(a,l){return n(e,void 0,void 0,function(){var n,e,s;return t(this,function(t){switch(t.label){case 0:return(e=r.url)?[3,2]:[4,c().catch(function(){return l("Could not auto-detect DNA interface from conductor. Ensure the web UI is hosted by a Holochain Conductor or manually specify url as parameter to connect")})];case 1:e=t.sent(),t.label=2;case 2:return n=e,r.timeout||i,(s=new o.Client(n,r.wsClient)).on("open",function(){return"WS open"}),s.on("close",function(){return"WS closed"}),s.once("open",function(){a({call:function(){for(var n=[],t=0;t<arguments.length;t++)n[t]=arguments[t];return function(t){var e=1===n.length?n[0]:n.join("/");return u(s,e,t,r.timeout)}},callZome:function(n,t,e){return function(o){return u(s,"call",{instance_id:n,zome:t,function:e,args:o},r.timeout)}},close:function(){return s.close()},onSignal:function(n){s.socket.on("message",function(t){if(t){var e=JSON.parse(t);(e.signal||e.instance_stats)&&n(e)}})},ws:s})}),[2]}})})})};var a={connect:exports.connect};
